...
export default function About() {
  return (
    <div className='bg-accent-3 pb-32 mt-32 overflow-hidden'>
      ...
      <div className='flex flex-col lg:flex-row gap-10 justify-center pt-20 px-6 lg:px-0'>
        <div className='text-center flex flex-row lg:flex-col gap-5 lg:items-center items-end'>
          <img src='me.svg' alt='A photo of Abigail' className='lg:w-full w-40'/>
          <h2 className='font-bowlby lg:block hidden text-6xl'>about <span className='text-accent-1'>me.</span></h2>
